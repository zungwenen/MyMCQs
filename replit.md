...
- **Scenario-Based Questions**: Database schema supports scenarios with passages and multiple related questions. Each scenario can contain MCQ, Boolean, or Fill-in-gap questions. Backend API routes ready for CRUD operations (admin UI pending implementation).
